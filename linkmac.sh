# $R/org/fxmisc/richtext/richtextfx/$RTV/richtextfx-$RTV.jar:\
. ./loadprops_mac.sh
...
$R/com/panopset/minpin/$PV/minpin-$PV.jar:\
...
jpackage \
  ...
  -m com.panopset.joist/com.panopset.joist.FlywheelJoist \
  --vendor "Panopset" \
  ...
  --add-launcher minpin=launchers/minpin.properties \
