...
Make sure your local properties are [loaded](../local/README.md).
...
(You might see a message saying that a system restart is required.  For the purposes of this documentation, it will be assumed that if you are reading this, you would just do a 'reboot 0' as a matter of course, as this is not a beginners step by step.)
...
...and change the server User from root to your ~/.com.panopset.deploy.properties $PAN_USR user in your ssh config.
...
Deploy just the spring boot web.jar...
